...
public class TestDBManager {
	...
	private static TestDBManager dbManager = null;
	private List<Connection> conManager = null;
	private Properties props = null;
	private TestMessageBundle mb = null;

	/**
	 * Private constructor
	 */
	private TestDBManager() throws CPException {
		mb = TestMessageBundle.getBundle();
		loadConnProperty();
		initialization();
	 ...
	 * @throws CPException
	 */
	public static TestDBManager getDBManager() throws CPException {
		if (null == dbManager) {
